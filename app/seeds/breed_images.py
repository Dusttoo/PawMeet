...
def seed_breed_images():
    ...
    db.session.add(bulldog1)
    db.session.add(bulldog2)
    db.session.add(bulldog3)
    db.session.add(bulldog4)
    db.session.add(bulldog5)

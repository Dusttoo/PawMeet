...
const LoginForm = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://assets-global.website-files.com/5ef2757ec474d80aea09a025/5fbe798b8763824ba303bbc3_petplan-help-dog-og.jpg")',
      }}
    >
      <form className="login-form" onSubmit={onLogin}>
        ...
        <p className="already">
          ...
          <Link className="login-redirect" to="/sign-up">
            Sign Up
          </Link>
        </p>
